 ...
 * _```wastelands```: A deserted dimension with structures, both above and below bedrock. Only portal activation can be disabled._
 * _```nova_structures```: Also known as [___Dungeons and Taverns___](https://modrinth.com/datapack/dungeons-and-taverns). Can't be disabled._
 * _```disable_alexscaves_magnets```: Disable all the magnetic forces defined in alexs caves mod._
